...
function definitionAsSeen(){
    var x=document.getElementById("nrvd_codebeautified").value;
    ...
    x = termFmt + " " + catgramFmt + " "+ acceptionFmt + x;
...
if (Drupal.jsEnabled){
	...
	$("#nrvd_codebeautified").keyup(function () {
	    $("#definition_seen").html(definitionAsSeen());
	}).keyup();

	$("#nrvd_codebeautified").change(function () {
	    $("#definition_seen").html(definitionAsSeen());
	});
